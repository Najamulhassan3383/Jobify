            ...
            <div>
                ...
                <div className="w-1/2 px-3 mb-5">
                  ...
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                      <span className="mdi mdi-account-outline text-gray-400 text-lg"></span>
                    </div>
                    <input
                      type="text"
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  ...
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                      <span className="mdi mdi-email-outline text-gray-400 text-lg"></span>
                    </div>
                    <input
                      type="email"
                      className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-12">
                  ...
                  <div className="flex">
                    <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                      <span className="mdi mdi-lock-outline text-gray-400 text-lg"></span>
                    </div>
                    <input
                      type="password"
                      className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
              ...
              <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                  <button className="bg-gradient-to-r from-purple-400 to-blue-500 hover:from-pink-500 hover:to-orange-500 text-white font-semibold px-6 py-3 rounded-md mr-6 w-full">
                    REGISTER NOW
                  </button>
                </div>
              </div>
